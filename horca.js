...
let palabras = ['ALURA', 'AHORCADO', 'HTML', 'ORACLE', 'JAVASCRIPT', 'LOGICA', 'PROGRAMACION', 'DESAFIO'];
...
function guardarPalabra(){
  ...
  if(nuevaPalabra !== ""){
    ...
    ("Ninguna palabra ha sido digitada")
  }
}
    ...
    document.onkeydown = (e) => {
        ...
        let letra = e.key.toUpperCase()
          ...
          if (letrasIncorrectas.length <= numeroDeErrores){
            ...
            alert("Has pasado el número de letras correctas")
          }
